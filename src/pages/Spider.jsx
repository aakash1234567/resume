    ...
    class Pea {
      constructor(className) {
        ...
        this.eyeLeft = {
          ...
          get xMin() {
            return (
              parseInt(this.element.getAttribute("cx")) -
              this.radius +
              pupilPadding
            );
          },
          ...
          get yMin() {
            return (
              parseInt(this.element.getAttribute("cy")) -
              this.radius +
              pupilPadding
            );
          },
          ...
          get center() {
            return getItemCenter(
              this.element.getAttribute("cx"),
              this.element.getAttribute("cy")
            );
          },
        };
        this.eyeRight = {
        ...
        this.pupilLeft.element.setAttribute(
          "cx",
          this.eyeLeft.xMin + this.pupilLeft.radius * 2
        );
        this.pupilLeft.element.setAttribute(
          "cy",
          this.eyeLeft.yMin + this.pupilLeft.radius * 2
        );

        this.pupilRight.element.setAttribute(
          "cx",
          this.eyeRight.xMin + this.pupilRight.radius * 2
        );
        this.pupilRight.element.setAttribute(
          "cy",
          this.eyeRight.yMin + this.pupilRight.radius * 2
        );
      ...
      update() {
        let amountY =
          (this.eyeLeft.yMax - this.eyeLeft.yMin - this.pupilLeft.radius * 3) *
          (mouseY / document.body.clientHeight);
        let amountX =
          (this.eyeLeft.xMax - this.eyeLeft.xMin - this.pupilLeft.radius * 3) *
      ...
      >
        <g transform="scale(.115)" class="pea pea-1">
          ...
          <rect
            ...
            width="34"
            height="33"
            transform="rotate(-29.5 583 587.742)"
            fill="white"
          />
          <path
            class="tongue"
